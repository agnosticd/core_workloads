...
The role automatically creates and assigns users to default groups:

* Admin and cluster accounts are assigned to: `/admins`
* Regular user accounts are assigned to: `/users`
